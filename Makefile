...
# C File
CSRCS := \
	$(shell find Core -maxdepth 1 -type f -name "*.c") \
	$(shell find Drivers -maxdepth 2 -type f -name "*.c") \
	$(shell find FreeRTOS -maxdepth 1 -type f -name "*.c") \
	$(shell find FreeRTOS/portable/GCC/ATM_CM4_MPU -maxdepth 1 -type f -name "*.c") \
	$(shell find hard -maxdepth 2 -type f -name "*.c") \
	$(shell find IQ -maxdepth 2 -type f -name "*.c") \
	$(shell find OS -maxdepth 2 -type f -name "*.c") \
...
# ASM File (*.s)
ASRCS := \
	$(shell find Core/stm32f427/gcc -maxdepth 1 -type f -name "*.s") \
